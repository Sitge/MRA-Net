...
data_root = ""
gt_root = os.path.join(data_root, "GT")  # Ground Truth 根目录
...
total_img_patches, total_msk_patches = [], []  # patches for all the images and masks

possible_extensions = [".tiff", ".tif", ".png", ".jpg", ".jpeg", ".bmp"]
TILE_SIZE = 256  # 假设补丁大小是 256x256

# 获取 data_root 目录下的所有文件，并且只保留图像文件，过滤掉子目录
